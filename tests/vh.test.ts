...
test('Nested', async () => {
  const result = await buildTestFile('vh-nested.xml');
  expect(result).toBe('<div style="display:flex;flex:1 1 0;flex-direction:column;"><div style="display:flex;flex:1 1 0;"><div style="display:flex;flex:1 1 0;flex-direction:column;">  h i </div></div><div style="display:flex;flex:0 1 auto;flex-direction:column;"> i </div><div style="display:flex;flex:1 1 0;margin:20px;"><div style="display:flex;flex:1 1 0;"><p style="flex:1 1 0;">1</p><p style="flex:1 1 0;">2</p><div style="display:flex;flex:1 1 0;">3</div></div></div></div>');
});
